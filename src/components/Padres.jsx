...
const Padres = () => {
  ...
  return (
    <div className="bg-[url(https://res.cloudinary.com/dnrcmjyu1/image/upload/v1719177032/kevin/images-8_fezwbl.jpg)] bg-cover bg-center md:mx-24 lg:mx-32 flex flex-col items-center pb-2">
